...
describe('Dashboard testing', () => {
  ...
  beforeEach(() => {
    // "mount" will actually mount the component directly the DOM even though we don't see it
  ...
  test('Adding a new expense to the state', () => {
    ...
    expect(mountedDashboard.find('p').text()).toEqual('Your total costs are: $10');
    console.log(mountedDashboard.instance())
  });
});
